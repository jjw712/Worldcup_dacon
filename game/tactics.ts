...
export const TACTIC_PRESETS: TacticPreset[] = [
  ...
  },
  {
    ...
    name: "후방 빌드업",
    formation: "3-5-2",
    summary: "세 명의 센터백과 중원 숫자로 압박을 풀어내는 전개",
    risk: "윙백 뒷공간",
    pressing: 50,
    defensiveLine: 54,
    tempo: 55,
    ...
    slots: [
      { x: 0.08, y: 0.5 },
      { x: 0.21, y: 0.26 }, { x: 0.19, y: 0.5 }, { x: 0.21, y: 0.74 },
      { x: 0.41, y: 0.12 }, { x: 0.38, y: 0.34 }, { x: 0.36, y: 0.5 },
      { x: 0.38, y: 0.66 }, { x: 0.41, y: 0.88 },
      { x: 0.69, y: 0.38 }, { x: 0.69, y: 0.62 },
    ],
  },
  {
    id: "SHADOW_3421",
    name: "하프스페이스 공략",
    formation: "3-4-2-1",
    summary: "두 명의 2선 공격수가 중앙과 측면 사이를 점유",
    risk: "전환 수비 부담",
    pressing: 67,
    defensiveLine: 63,
    tempo: 65,
    ...
    slots: [
      { x: 0.08, y: 0.5 },
      { x: 0.21, y: 0.27 }, { x: 0.19, y: 0.5 }, { x: 0.21, y: 0.73 },
      { x: 0.4, y: 0.14 }, { x: 0.38, y: 0.4 }, { x: 0.38, y: 0.6 },
      { x: 0.4, y: 0.86 }, { x: 0.59, y: 0.36 }, { x: 0.59, y: 0.64 },
      { x: 0.73, y: 0.5 },
    ],
  },
  {
    ...
    name: "중원 압축",
    formation: "4-1-4-1",
    summary: "수비형 미드필더를 축으로 두 줄 간격을 좁게 유지",
    risk: "원톱 고립",
    pressing: 58,
    defensiveLine: 48,
    tempo: 52,
    ...
    slots: [
      { x: 0.08, y: 0.5 },
      { x: 0.2, y: 0.14 }, { x: 0.18, y: 0.38 }, { x: 0.18, y: 0.62 },
      { x: 0.2, y: 0.86 }, { x: 0.33, y: 0.5 },
      { x: 0.47, y: 0.18 }, { x: 0.44, y: 0.4 }, { x: 0.44, y: 0.6 },
      { x: 0.47, y: 0.82 }, { x: 0.7, y: 0.5 },
    ],
  },
];
